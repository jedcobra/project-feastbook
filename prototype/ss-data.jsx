// ss-data.jsx — Sample content for Special Spoon prototype
// Real-feeling recipes, people, feed items, comments.
...
const byHandle = (h) => SS_PEOPLE.find(p => p.handle === h);
...
const SS_RECIPES = [
  {
    ...
    saves: 1240,
    rating: 4.8,
    intro: 'The first time I made this I used up the end of a tub of white miso and half a stick of butter. I have been chasing that exact meal ever since. The trick is to push the butter past golden into a deep, nutty amber — the miso then tips it into something strange and wonderful.',
    ingredients: [
      { section: 'For the pasta', items: [
        { q: '200g', i: 'bucatini or spaghetti' },
        { q: '1 tbsp', i: 'sea salt, for the water' },
      ]},
      { section: 'For the sauce', items: [
  ...
  },
  {
    ...
    saves: 2180,
    rating: 4.9,
    intro: 'I watched my mum make this a hundred times before I tried to write it down. She measures everything by feel — \u201ca proper spoon,\u201d \u201cenough water.\u201d This is my attempt to pin that down without losing the soul of it.',
    ingredients: [
      { section: 'Base', items: [
  ...
  },
  {
    ...
    saves: 320,
    rating: 4.7,
    intro: 'I make this every other Saturday. Mix the night before, fridge overnight, bake in the morning. The hands-on time is maybe fifteen minutes, spread across two days.',
    ingredients: [
      { section: null, items: [
    ...
    notes: [
      { by: 'You', text: 'Works with 100% whole wheat if you up the water to 440g.' },
    ],
    comments: [
      { by: 'rensmallkitchen', text: 'Made three in a row. Now obsessed.', likes: 4 },
    ],
  },
  {
    id: 'preserved-lemons',
    ...
    author: 'sambeau',
    seed: 2, time: '30 days', serves: 1, difficulty: 'Easy',
    tags: ['preserves', 'pantry'], madeIt: 19, saves: 410, rating: 4.6,
    intro: '', ingredients: [], steps: [], notes: [], comments: [],
  },
  {
    id: 'lentil-soup',
    ...
    author: 'dev.iyer',
    seed: 7, time: '35 min', serves: 4, difficulty: 'Easy',
    tags: ['soup', 'vegan', 'weeknight'], madeIt: 208, saves: 1580, rating: 4.8,
    intro: '', ingredients: [], steps: [], notes: [], comments: [],
  },
  {
    id: 'tarte-tatin',
    ...
    author: 'coral',
    seed: 3, time: '1 hr', serves: 6, difficulty: 'Medium',
    tags: ['dessert', 'french'], madeIt: 64, saves: 980, rating: 4.7,
    intro: '', ingredients: [], steps: [], notes: [], comments: [],
  },
  {
    id: 'greens',
    ...
    author: 'luminous',
    seed: 1, time: '15 min', serves: 2, difficulty: 'Easy',
    tags: ['side', 'weeknight', 'vegan'], madeIt: 92, saves: 640, rating: 4.5,
    intro: '', ingredients: [], steps: [], notes: [], comments: [],
  },
];

const recipeById = (id) => SS_RECIPES.find(r => r.id === id);

// ─────────────────────────────────────────────────────────────
// Feed activity — what friends are up to
// ─────────────────────────────────────────────────────────────
const SS_FEED = [
...
// ─────────────────────────────────────────────────────────────
// Cookbooks / shelves — curated collections
// ─────────────────────────────────────────────────────────────
const SS_SHELVES = [
...
Object.assign(window, { SS_PEOPLE, SS_RECIPES, SS_FEED, SS_SHELVES, byHandle, recipeById });
